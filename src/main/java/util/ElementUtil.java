...
public class ElementUtil {
	...
	public void printElementsText(By locator) {
		getElementsTextList(locator).forEach(System.out::println);
	}

	public void getAttributeList(By locator, String attr) {
		List<WebElement> attrList = getElements(locator);
		for (WebElement webElement : attrList) {
			String srcVal = webElement.getAttribute(attr);
	...
	public void printDropDownOptions(By locator) {
		getDropDownOptions(locator).forEach(System.out::println);
	}
	...
	public void printElementsText(By locator, int timeOut) {
		waitForVisibilityOfElements(locator, timeOut).forEach(e -> System.out.println(e.getText()));
	}
	...
	public void waitForTitle(String titleFraction, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
